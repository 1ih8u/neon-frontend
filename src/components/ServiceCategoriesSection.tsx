      ...
      <div className="mx-auto px-[5%] md:px-[15%]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-2 md:gap-6 justify-items-center md:justify-items-stretch">
          {serviceCategories.map((category) => (
            <a href="#neon-sign" key={category.id} className="md:w-full">
              <div className="relative w-[140px] h-[160px] md:w-auto md:h-[440px] rounded-3xl overflow-hidden group cursor-pointer">
